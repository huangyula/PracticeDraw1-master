...
//        练习内容：使用各种 Canvas.drawXXX() 方法画饼图
    ...
    private void initCircle() {
        ...
        mInnerOvalShape = new RectF(100, 50, 400, 350);//内圆，左上角坐标（100,50），右下角（500,450），圆半径为200
        mOutterOvalShape = new RectF(90, 40, 390, 340);//外圆，左上角坐标（90,40），右下角（490,440），圆半径为200
